...
var rtccOptions = {
  debugLevel: 3,
  //the id of the html element that will be used as the video container
  //if nothing is given, the video will be embedded in a draggable box displayed over the page
